...
local Tabs = {
    ...
    Buy = Window:AddTab("Mua hàng", "shopping-cart"),
    Settings = Window:AddTab("Cài đặt", "settings"),
}

-- ===================== NÔNG TRẠI =====================

local HarvestGroup = Tabs.Farm:AddLeftGroupbox("Thu hoạch", "apple")
...
HarvestGroup:AddLabel('<font color="rgb(85, 255, 85)">Ví dụ: 1 = 1x | 1.5 = 1.5x | 0.5 = 0.5x</font>', true)
...
local FruitGroup = Tabs.Farm:AddLeftGroupbox("Thu trái", "grape")
...
local PlantGroup = Tabs.Farm:AddRightGroupbox("Trồng cây", "sprout")
...
local SellGroup = Tabs.Farm:AddRightGroupbox("Bán & Rebirth", "banknote")
...
SellGroup:AddToggle("AutoRebirth", {
    Text = "Tự động Rebirth",
    Default = false,
})

SellGroup:AddSlider("RebirthMaxLevel", {
...
SellGroup:AddToggle("RebirthNotify", {
    Text = "Thông báo khi Rebirth",
    Default = true,
})

SellGroup:AddSlider("RebirthLoopDelay", {
    Text = "Độ trễ vòng lặp Rebirth",
    Default = 5,
    Min = 1,
    Max = 60,
    Rounding = 1,
...
local BuyGroup = Tabs.Buy:AddLeftGroupbox("Mua hạt", "shopping-cart")
...
local BuyLimitGroup = Tabs.Buy:AddRightGroupbox("Giới hạn mua", "sliders-horizontal")
...
local FurnitureGroup = Tabs.Buy:AddLeftGroupbox("Mua nội thất", "sofa")
...
local DiscordGroup = Tabs.Settings:AddRightGroupbox("Discord", "message-circle")
...
DiscordGroup:AddLabel("Mọi script đều không key.", true)
DiscordGroup:AddLabel("Vào Discord để lấy config sẵn.", true)
